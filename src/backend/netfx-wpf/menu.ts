...
export function setMenu(window: { browserWindow: unknown; pendingMenu?: MenuItemOptions[] }, menu: unknown[]): void {
    (window as any).pendingMenu = menu;
}

export function buildWpfMenu(window: { browserWindow: unknown; webView: unknown; pendingMenu?: unknown[] | null }): void {
